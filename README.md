...
Prism uses **Convex** with 9 tables and full indexing:

```mermaid
erDiagram
    profiles {
        string userId PK
        boolean preferCodeExamples
        string verbosity
    ...
    insights ||--o{ citations : "references"
    citations }o--|| sources : "points to"
    sources ||--o{ ragDocuments : "has"
    ragDocuments ||--o{ ragChunks : "split into"
    profiles ||--o{ sessions : "owns"
    profiles ||--o{ episodicMemories : "remembers"
```
